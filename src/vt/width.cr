module Term::VT
  module Width
    COMBINING_RANGES = [
      ...
      {0x0a70, 0x0a71}, {0x0a75, 0x0a75}, {0x0abc, 0x0abc},
      ...
      {0x202a, 0x202e}, {0x2060, 0x206f}, {0x20d0, 0x20ff},
    ...
    WIDE_RANGES = [
      ...
      {0x3000, 0x303e}, {0x3041, 0x3096}, {0x309b, 0x30ff},
      ...
      {0x1f240, 0x1f248}, {0x1f250, 0x1f251}, {0x1f300, 0x1f64f},
    ...
    def self.of(char : Char) : Int32
      code = char.ord
      return 0 if code == 0
      return 0 if code < 0x20 || (code >= 0x7f && code < 0xa0)
      return 0 if in_ranges?(code, COMBINING_RANGES)
      return 2 if in_ranges?(code, WIDE_RANGES)

      1
    end

    private def self.in_ranges?(code : Int32, ranges) : Bool
      low = 0
      high = ranges.size - 1
